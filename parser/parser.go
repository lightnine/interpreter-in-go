...
func New(l *lexer.Lexer) *Parser {
	...
	p.registerPrefix(token.LBRACKET, p.parseArrayLiteral) // 遇到[ 后，执行parseArrayLiteral
...
func (p *Parser) ParseProgram() *ast.Program {
	...
	// 依次获取token，解析token，添加到statements中
...
func (p *Parser) parseLetStatement() *ast.LetStatement {
	...
	// 检查下一个token是否为IDENT，如果是，则前进一个token
